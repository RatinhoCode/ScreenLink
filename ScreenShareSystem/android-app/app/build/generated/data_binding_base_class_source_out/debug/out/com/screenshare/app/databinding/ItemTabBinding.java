...
public final class ItemTabBinding implements ViewBinding {
  ...
  private ItemTabBinding(@NonNull LinearLayout rootView, @NonNull TextView tabClose,
      @NonNull TextView tabLabel) {
  ...
  public static ItemTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tabLabel;
      TextView tabLabel = ViewBindings.findChildViewById(rootView, id);
      if (tabLabel == null) {
        break missingId;
      }

      return new ItemTabBinding((LinearLayout) rootView, tabClose, tabLabel);
    }
